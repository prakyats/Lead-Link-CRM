  ...
  return (
    <div
      ...
      className={cn(
        ...
        !isStatic && "hover:scale-[1.02] active:scale-95",
        isActive
          ? "ring-2 ring-primary/80 bg-primary/5 shadow-[0_0_25px_rgba(34,197,94,0.3)] scale-[1.02]"
          : !isStatic && "opacity-80 hover:opacity-100 hover:ring-1 hover:ring-primary/30 hover:bg-primary/[0.02] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)]",
        className
      )}
    >
      {/* Top Accent Bar */}
      <div
        className={cn(
          ...
          isActive ? "bg-primary opacity-100" : !isStatic && "bg-primary opacity-0 group-hover:opacity-40"
        )}
      />
      ...
      <div className={cn(
        "relative z-10 transition-all duration-500 pr-12",
        !isStatic && "group-hover:opacity-40 group-hover:-translate-x-2"
      )}>
        {children}
      </div>
    </div>
